                    ...
                    <div class="col-lg-5 no-padding">
                        <div class="signup login-box">
                            ...
                            <div class="login-row row no-margin signup">
                                <label for=""><i class="fas fa-envelope"></i>Enter New Password</label>
                                <input type="text" class="form-control form-control-sm">
                            </div>
                            <div class="login-row row no-margin signup">
                                <label for=""><i class="fas fa-envelope"></i>Confirm New Password</label>
                                <input type="text" class="form-control form-control-sm">
                            </div>

                            <div class="login-row btnroo row no-margin signup">
                                <a id="signin-btn" class="btn btn-primary btn-sm" href="login.php">Reset</a>
