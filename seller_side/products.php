		...
		<div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.php"><img class="logo-icon me-2" src="assets/images/circol_logo.png" alt="logo"></a>
		        </div><!--//app-branding-->  
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    <div class="col-auto">
								    <form class="products-search-form row gx-1 align-items-center">
					                    <div class="col-auto">
							    ...
							    <div class="col-auto">
								    ...
								    <select class="form-select w-auto">
										  ...
										  <option value="option-2">Shirt</option>
										  <option value="option-3">Lanyard</option>
